...
// program when typing in "Q" or "q".
		Scanner input = new Scanner(System.in);
		 ...
		 while (true) {
	            ...
	            /* 'R' for Refilling the array with random numbers*/
	            ...
	            try {
	                ...
	                if (k < 1 || k > SIZE_OF_ARRAY) {
	                    System.out.println("Invalid number. Please enter k between 1 and " + SIZE_OF_ARRAY + ".");
	                    continue;
	                }

	                /*deep copy to avoid altering the original array*/
	                System.arraycopy(array, 0, arrayTmp, 0, SIZE_OF_ARRAY);
	                ...
	                System.out.println("Invalid input. Please enter an integer, 'R', or 'Q'.");
	            }
	        }
